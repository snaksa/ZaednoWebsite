<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="EditAcceptedWorks.aspx.cs" Inherits="FullSchoolWebsite.AdminPanel.EditAcceptedWorks" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Администраторски панел - Редактиране на творба</title>
</asp:Content>

<asp:Content ID="Name" ContentPlaceHolderID="page_name" runat="server">
    <h2 class="section_title">Редактиране на творба</h2>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <section id="main" class="column">
        ...
        <article class="module width_full">
            <header>
                <h3>Редактиране на творба</h3>
            </header>

            <div class="module_content">

                <fieldset>
                    <label>Заглавие на творба</label>
            ...
            <footer>
                <div class="submit_link">
                    <asp:Button runat="server" ID="EditNews" Text="Редактирай" CssClass="alt_btn" OnClick="EditWorks_Click" />
                </div>
            </footer>
        </article>
