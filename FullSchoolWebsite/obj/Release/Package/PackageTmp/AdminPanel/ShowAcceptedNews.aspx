<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="ShowAcceptedNews.aspx.cs" Inherits="FullSchoolWebsite.AdminPanel.ShowAcceptedNews" ClientIDMode="Static" %>
...
<asp:Content ID="Name" ContentPlaceHolderID="page_name" runat="server">
    <h2 class="section_title">Одобрени новини</h2>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <section id="main" class="column">
        ...
        <article class="module width_full" id="newsArticle">
            <header>
                <h3 class="tabs_involved" id="sectionName">Одобрени новини</h3>
            </header>
            <div class="tab_container" style="max-height: 400px; overflow-y: scroll;">
                <div id="tab1" class="tab_content">
                    <table class="tablesorter" cellspacing="0">
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="AcceptedNewsRepeater">
                                <ItemTemplate>
                                    <tr>
                                        <td><%#Eval("Title") %></td>
                                        ...
                                        <td style="width: 90px; text-align: center;">
                                            ...
                                            <img id='<%#Eval("ID") %>' src="images/icn_trash.png" class="imageActions" onclick="PaintBackgroundRed(this.id, 'newsToDelete')" />
            ...
            <footer>
                <div class="submit_link">
                    <asp:Button runat="server" ID="ButtonDeleteSelectedNews" CssClass="alt_btn"
                        OnClick="ButtonDeleteSelectedNews_Click" Text="Изтрий маркираните новини" />
                </div>
            </footer>
        </article>
        ...
        <asp:HiddenField runat="server" ID="newsToDelete" Value="" />
