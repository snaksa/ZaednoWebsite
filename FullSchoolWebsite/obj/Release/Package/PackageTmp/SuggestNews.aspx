<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/UserInterface.Master" AutoEventWireup="true" CodeBehind="SuggestNews.aspx.cs" Inherits="FullSchoolWebsite.SuggestNews" ClientIDMode="Static" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderPlaceHolder" runat="server">
    <title>Предложете новина - Клуб по журналистика - СОУ "Христо Ботев" гр. Кубрат</title>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="page-title"><h1>Предложете новина</h1></div>
