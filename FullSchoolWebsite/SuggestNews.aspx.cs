...
using FullSchoolWebsite.AdminPanel;

namespace FullSchoolWebsite
{
    public partial class SuggestNews : System.Web.UI.Page
    {
        ...
        {
            if (!ImageFileUpload.HasFile || CKEditor.Text == String.Empty || AuthorEmailTextBox.Value == String.Empty || NewsTitleTextBox.Value == String.Empty)
            {
            ...
            string query = "INSERT INTO SuggestedNews(Title, Text, ImagePath, Author, ShowEmail, Email, Date) "
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    //success message
                    ScriptManager.RegisterStartupScript(this, GetType(), "alert2", "alert('Новината е предложена успешно!');", true);
                    return;
                }
                catch (Exception ex)
                {
