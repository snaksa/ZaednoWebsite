...
namespace FullSchoolWebsite.AdminPanel
{
    public partial class AddNews : System.Web.UI.Page
    {
        ...
        protected void AddNewNews_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO AcceptedNews(Title, Text, ImagePath, Status, Author, ShowEmail, Email, Date, PositiveVotes, NegativeVotes, Views) " +
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    AlertBox.Visible = true;
                    AlertBox.InnerText = "Новината беше добавена успешно!";
                }
                catch (Exception ex)
                {
                    //error message
