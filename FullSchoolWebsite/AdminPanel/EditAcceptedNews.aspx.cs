...
{
    public partial class EditAcceptedNews : System.Web.UI.Page
    {
        ...
        protected void EditNews_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["NewsDBConnectionString"].ConnectionString;
            string queryWithImage = "UPDATE AcceptedNews SET Title = @title, Text = @text, ImagePath = @imagePath, Author = @author, ShowEmail = @showEmail, Email = @email, Status = @status WHERE ID = @id";
            string queryWithoutImage = "UPDATE AcceptedNews SET Title = @title, Text = @text, Author = @author, ShowEmail = @showEmail, Email = @email, Status = @status WHERE ID = @id";
